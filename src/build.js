...
const fileContents = (
`//classified.html requires JavaScript to work properly. Try other browser or device.<!DOCTYPE html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1.0'></head><body><script>
${main}
//</script></body></html>`);
